...
public class TextFieldSuggestionUI extends MetalTextFieldUI {
    ...
    private void initializeComponent() {
        ...
        textfield.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent fe) {
                border.setColor(new Color(159,88,187));
                textfield.repaint();
            }
            
            @Override
            public void focusLost(FocusEvent fe) {
                border.setColor(new Color(27,49,89));
                textfield.repaint();
    ...
    private class Border extends EmptyBorder {
        private Color focusColor = new Color(159,88,187);
        private Color color = new Color(27,49,89);
        private int round;
